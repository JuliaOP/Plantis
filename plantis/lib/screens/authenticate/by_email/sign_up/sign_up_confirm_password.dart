...
class ConfirmPassword extends StatefulWidget {
  ...
  ConfirmPassword({this.email, this.password});
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: FadeAnimation(1.5, Text(
                "Insira a mesma senha que anteriormente",
                style: TextStyle(
                  fontFamily: "Metropolis semi bold",
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () async {
                  if( equals(password, widget.password) ){
                    dynamic result = await _auth.registerWithEmailAndPassword(widget.email, widget.password);
                    if(result == null){
                      setState(() => error = 'Por favor insira um email valido'
                      );
                    }else {
                      Navigator.push(
                          context,
                    ...
                    dialogs.information(context, "Ops...", "A senha não está correta.");
                  }
                },
              ...
              child: GestureDetector(
                onTap: () async {
                  if( equals(password, widget.password) ){
                    ...
                    dialogs.information(context, "Erro", "Entradas com erro");
                    }
