...
import 'package:plantis/screens/authenticate/by_email/sign_up/sign_up_password.dart';
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: FadeAnimation(1.5, Text(
                "Insira o endereço de e-mail que deseja usar para se registrar",
                style: TextStyle(
                  fontFamily: "Metropolis semi bold",
              ...
              child: GestureDetector(
                onTap: () async {
                  if(isEmail(email)){
                    ...
                    //pop an alert "enter valid email" with "ok" button
